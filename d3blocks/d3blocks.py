    ...
    * Blogs: https://erdogant.medium.com
    ...
    def scatter(self,
        ...
        * https://d3blocks.github.io/d3blocks/pages/html/Scatter.html
        ...
        # Store properties
        self.config = self.chart.set_config(config=self.config, filepath=filepath, title=title, showfig=showfig, overwrite=overwrite, figsize=figsize, cmap=cmap, scale=scale, ylim=ylim, xlim=xlim, label_radio=label_radio, color_background=color_background, dark_mode=dark_mode, reset_properties=reset_properties, notebook=notebook, jitter=jitter, save_button=save_button, show_side_panel=show_side_panel, show_top_panel=show_top_panel, logger=logger)
        # Check exceptions
    ...
    def movingbubbles(self,
                      ...
                      speed: dict = {"slow": 750, "medium": 250, "fast": 25, "superfast": 5},
                      figsize = [1024, 768],
                      note: str = None,
                      time_notes: str = None,
                      show_side_panel: bool = True,
    ...
    def radialgraph(self,
        ...
        * https://d3blocks.github.io/d3blocks/pages/html/RadialGraph.html
        ...
        self.config = self.chart.set_config(
            ...
            expand_all_on_load=expand_all_on_load,
...
def set_chart_func(chart=None, logger=None):
    ...
    if chart is not None:
        ...
        if np.isin(chart, ['RadialGraph', 'Maps', 'Chord', 'Sankey', 'Timeseries', 'Violin', 'Movingbubbles', 'Scatter', 'Heatmap', 'Matrix', 'Treemap', 'Tree', 'Circlepacking', 'Radialgraph']):
            chart=eval(chart)
        else:
