...
class D3Blocks():
    ...
    * Movingbubbles: https://towardsdatascience.com/how-to-create-storytelling-moving-bubbles-charts-in-d3js-with-python-b31cec7b8226
    ...
    def violin(self,
               x,
               y,
               size: Union[float, List[float]] = 5,
               color: Union[str, List[str]] = None,
               x_order: list[str] = None,
               opacity: Union[float, List[float]] = 0.6,
               stroke: Union[str, List[str]] = '#000000',
               tooltip: Union[str, List[str]] = None,
