...
# ----------------------------------------------------------------------
d3 = D3Blocks(chart='radialgraph')
filepath = r'D:\REPOS\erdogant.github.io\docs\d3blocks\radialgraph_focus.html'
df = d3.import_example('energy')
...
# ----------------------------------------------------------------------
d3 = D3Blocks(chart='radialgraph')
filepath = r'D:\REPOS\erdogant.github.io\docs\d3blocks\radialgraph_significance.html'
df = d3.import_example('energy')
...
filepath = r'D:\REPOS\erdogant.github.io\docs\d3blocks\radialgraph_nodeproperties.html'
df = d3.import_example('energy')
